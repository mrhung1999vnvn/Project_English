...
import { Container, Title, Card, TextRN, ButtonIcon, ButtonRN } from "../../common/components";
            ...
            <ScrollView>
                ...
                <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', marginVertical: 20 }}>
                    <View style={{ borderRadius: 180, elevation: 5 }}>
                        <Image source={{ uri: uContext.data.avatar }} style={{ width: 200, height: 200, borderRadius: 180, borderWidth: 1 }} resizeMethod={'resize'} resizeMode={'contain'} />
                    </View>
                    <Card>
                        <Title>{uContext.data.name}</Title>
                        <TextRN style={{ fontStyle: 'italic' }}>{uContext.data.email} </TextRN>
                    </Card>
                    ...
                    <ButtonRN onPress={_logOut} left={<Icon name='logout' size={20} color={'#fff'}/>} style={{width:'50%',alignItems:'center',justifyContent:'space-evenly',backgroundColor:'red'}}>Đăng xuất</ButtonRN>
                </View>
            </ScrollView>
        </Container>
    );
