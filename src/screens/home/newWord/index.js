        ...
        <Container>
            ...
            <View style={{height:'15%',justifyContent:'center',paddingHorizontal:30}}>
                <TouchableOpacity onPress={()=>navigation.navigate('Tab')} style={{flexDirection:'row'}}>
                    ...
                    <Text style={{fontSize:25,color:'#FF8811',fontWeight:'bold'}}> Choose new words</Text>
                </TouchableOpacity>
            </View>
            <View style={{flex:1,justifyContent:'center', alignItems:'center'}}>
                <FlatList
                    ...
                    renderItem={({item,index}) => <Item onSave={()=>_onSave(index,item)} onNext={()=>_onNext(index)} index={index} word={item} />}
